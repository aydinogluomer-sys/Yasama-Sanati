  ...
  return (
    <div className="max-w-editorial space-y-6 border-t border-cream/15 pt-10">
      <div className="space-y-2">
        ...
        <p className="text-xs md:text-sm font-light text-cream/85 max-w-lg mx-auto leading-relaxed">
        ...
        {status !== "success" ? (
          ...
          >
            ...
            <input
              ...
              className="min-h-12 flex-1 rounded border border-cream/15 bg-deep px-4 py-3 text-sm text-cream transition-colors placeholder:text-cream/85 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-copper-text"
            ...
            <button
              ...
              className="flex min-h-12 min-w-[120px] cursor-pointer items-center justify-center rounded bg-cream px-6 py-3 text-sm font-medium text-deep transition-colors duration-300 hover:bg-[#c4cbb1] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-copper-text focus-visible:ring-offset-2 focus-visible:ring-offset-deep disabled:cursor-wait disabled:bg-cream/50"
            >
              {status === "loading" ? (
                <>
                  <svg aria-hidden="true" className="h-5 w-5 animate-spin text-deep motion-reduce:animate-none" fill="none" viewBox="0 0 24 24">
