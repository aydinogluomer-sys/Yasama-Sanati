...
export default function IntroductionServer() {
  return (
    <section aria-label="Akademiyle tanış" className="grid grid-rows-[auto_auto_auto] gap-y-12 bg-[#2B3530] px-3-75 pt-42-5 pb-35 text-[#D1CCBF] md:grid-cols-[1fr_1.9fr] md:grid-rows-[auto_auto] md:gap-y-32 md:px-15 md:pt-56-25 md:pb-50">
      ...
      <EditorialSectionTitle index="01" className="md:col-start-1 md:row-start-2">
        Tanışma
      </EditorialSectionTitle>

      <div className="flex min-w-0 flex-col gap-12 md:col-span-2 md:col-start-2 md:gap-20">
